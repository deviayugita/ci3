      ...
      <div class="container">
        ...
        <!-- <div class="col-lg-2"></div> -->
            ...
            <div class="portfolio-caption">
              ...
              <a href="<?php echo site_url('Admin/detail/'.$row->id)?>">Lanjutkan</a>
              </p>
            </div>
            
              <a href="<?php echo site_url('Admin/update/'.$row->id)?>"><button class="btn btn-primary">Update</button></a>
             <a onclick="javascript:return confirm('Apakah anda ingin menghapus data ini ?')" href="<?php echo site_url('Admin/delete/'.$row->id) ?>"><button class="btn btn-danger">Delete</button></a>
