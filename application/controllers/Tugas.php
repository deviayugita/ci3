...
// 			$this->load->view('Profil/insert_blog',$data);
// 		}
// 		else{
...
// 		$this->load->model('Kategori_model');
// 		if($this->form_validation->run()==FALSE){
// 			$this->load->view('Profil/insert_kategori');
// 		}
// 		else{
...
// 		//Jika validasi belum berjalam
// 		if($this->form_validation->run()==FALSE){
// 			$this->load->view('Profil/update_kategori',$data);
// 		}
// 		else{
...
// }}
	...
	// 	redirect('Tugas/read_kategori','refresh');
	// }
}
